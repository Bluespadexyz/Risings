...
contract StakingRisings is Ownable, ReentrancyGuard {
    ...
    /* 4: Time Types */
    RewardCondition[4] public rewardCondition;
    ...
    constructor(address initialOwner) Ownable(initialOwner) {
        ...
        allowedToStake[0x81Ffb740B474C3c8D0e0B2B503068E1F1C56598a] = true;
        
        autoRestakeAsDefault = true;
        
        rewardCondition[0].amount = 5 * 10 ** 18;
        rewardCondition[0].period = 604800;


        rewardCondition[1].amount = 21 * 10 ** 18;
        rewardCondition[1].period = 2592000;


        rewardCondition[2].amount = 43 * 10 ** 18;
        rewardCondition[2].period = 5184000;

        rewardCondition[3].amount = 70 * 10 ** 18;
        rewardCondition[3].period = 7776000;
    }
    ...
    function pendingTicket(address _collection, address _user, uint256 _tokenId) public view returns (uint256, uint256) {
        ...
        if (EnumerableSet.contains(userInfo[_collection][_user].tokenIds, _tokenId)) {
            ...
            RewardCondition memory condition = rewardCondition[timeType];
