...
import { getContract, RISINGS_NFTS, VOLUME1_METADATA, REWARD_AMOUNTS } from "config/contracts";
...
import { callContract, contractFetcher, moralisFetcher } from "lib/contracts";
...
export function getPageTitle(data) {
  return `${data} | Life of Hel | Risings`;
}
...
export function getHomeUrl() {
  ...
  return "https://app.lifeofhel.xyz/";
}
