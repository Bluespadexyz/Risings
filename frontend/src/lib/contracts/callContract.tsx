      ...
      case NOT_ENOUGH_FUNDS:
        failMsg = (
          <div>
            ...
            <br />
            <br />
            <ExternalLink href="https://cronos.org/">Bridge CRO to Cronos</ExternalLink>
          </div>
        );
        break;
      case USER_DENIED:
      ...
      case RPC_ERROR:
        ...
        failMsg = (
          <div>
            ...
            <ExternalLink href="https://lifeofhelxyz.gitbook.io/lifeofhel/trading#backup-rpc-urls">More info</ExternalLink>
            <br />
