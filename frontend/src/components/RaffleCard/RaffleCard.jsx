...
import { formatAddress, formatRaffleCardTitle } from "../../utils/strings";
            ...
            <>
              {
                isWalletConnected ?
                  <>
                    <p className={cx("winning-rate")}>1x ticket winning rate:</p>
                    <p className={cx("winning-rate-percentage")}>{raffle.winningRate1x}%</p>
                    <p className={cx("winning-rate")}>your winning rate:</p>
                    <p className={cx("winning-rate-percentage")}>{raffle.winningRate}%</p>
                  </>
                  :
                  <>
                    <p className={cx("winning-rate")}>1x ticket winning rate:</p>
