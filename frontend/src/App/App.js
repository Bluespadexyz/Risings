...
import { Switch, Route, Routes, BrowserRouter, useNavigate } from "react-router-dom";
...
const EarnRisingsTickets = React.lazy(() => import("pages/EarnRisingsTickets"));
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>", and use Risings with its built-in browser"
            </>
          ) : (
            <>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>" to start using Risings"
            </>
          )}
        </div>
      );
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>", and use Risings with its built-in browser"
            </>
          ) : (
            <>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>" to start using Risings"
            </>
          )}
        </div>
      );
    ...
    <>
      ...
      <Suspense>
        <Routes>
          ...
          <Route path="/earn-loh-tickets" element={
            <EarnRisingsTickets
